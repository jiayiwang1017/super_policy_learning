...
import numpy as np
import pandas as pd
from rkhs_scaler import RKHSIV, RKHSIVCV, ApproxRKHSIV, ApproxRKHSIVCV, RKHSIV_q, RKHSIVCV_q, ApproxRKHSIV_q, ApproxRKHSIVCV_q
import sklearn
...
from torchSVC import RegimeLearner
import torch
...
class proxITR_numpy:
    def __init__(self, A,X,Z,W,Y, god=False, U=None, h0=None, q0=None, d_X_opt=None, learning_rate=0.1, n_epoch=10000, batch_size = 200, n_components = 150, opt='LBFGS', verbose=False):
        ...
        if self.god:
            try:
                self.d_X_opt = d_X_opt.astype(int).reshape(-1)
                self.U = U
                self.h0 = h0
                self.q0 = q0
            except:
